...
import { readCompatibilityDate, writeCompatibilityDate } from '../lib/compatibility-date-file'
...
export const updateCompatibilityDate = async (outputDir: string): Promise<UpdateCompatibilityDateResult> => {
  ...
  console.log(`Saved compatibility date ${latestDate} (was ${previousLabel}).`)
